...
def main():
    ...
    if args.only_second_stage:
        ...
        for img_path in progressbar.progressbar(os.listdir(args.img_root)):
            # keep the person class bounding boxes.
            image_name=osp.join(args.img_root,img_path)
    ...
    for i, pose_det_results in progressbar.progressbar(enumerate(
