...
kp_path=r"F:\ViTPose\ViTPose\vis_results\Keypoints_1.json"
keypoints=json.load(open(kp_path))
video = mmcv.VideoReader(r"F:\ViTPose\ViTPose\test_vid\1.mp4")
...
img=imshow_keypoints_3d([keypoints[200]],
                    video[200],
                    skeleton,
                    pose_kpt_color,
                    pose_link_color)

mmcv.imshow(img,"image")
print(len(keypoints))
