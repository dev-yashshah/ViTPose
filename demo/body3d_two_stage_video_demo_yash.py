...
def main():
    ...
    parser.add_argument(
        ...
        #default='configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_huge_coco_256x192.py',
    ...
    parser.add_argument(
        ...
        #default='pretrained_weights/vitpose-h-multi-coco.pth',
    ...
    parser.add_argument(
        '--smooth-filter-cfg',
        type=str,
        default='configs/_base_/filters/savizky_golay.py',
    ...
    with open(osp.join(args.out_video_root,"Keypoints_"+osp.basename(args.video_path).split(".")[0]+".json"),"w+") as writer:
